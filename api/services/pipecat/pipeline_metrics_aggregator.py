...
class TTSAudioSecondsMetricsData(MetricsData):
    """Text-to-Speech audio duration metrics data.

    Parameters:
        value: Audio seconds generated by TTS.
    """
...
class PipelineMetricsAggregator(FrameProcessor):
    ...
    async def process_frame(self, frame: Frame, direction: FrameDirection):
        ...
        if isinstance(frame, StartFrame):
            ...
            for data in frame.data:
                ...
                elif isinstance(data, TTSAudioSecondsMetricsData):
                    await self._handle_tts_audio_seconds_metrics(data)
    ...
    async def _handle_tts_audio_seconds_metrics(self, data: TTSAudioSecondsMetricsData):
        key = f"{data.processor}|||{data.model}"
        self._tts_audio_seconds[key] += data.value
