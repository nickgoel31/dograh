...
uv pip install -e './pipecat[cartesia,deepgram,openai,elevenlabs,groq,google,azure,sarvam,smallest,soundfile,silero,webrtc,speechmatics,openrouter,camb,mcp]'
