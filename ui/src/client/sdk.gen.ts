 ...
 */
export const listAllOrganizationsApiV1SuperuserOrganizationsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAllOrganizationsApiV1SuperuserOrganizationsGetData, ThrowOnError>) => (options?.client ?? client).get<ListAllOrganizationsApiV1SuperuserOrganizationsGetResponses, ListAllOrganizationsApiV1SuperuserOrganizationsGetErrors, ThrowOnError>({ url: '/api/v1/superuser/organizations', ...options });

/**
 * Create Organization
 */
export const createOrganizationApiV1SuperuserOrganizationsPost = <ThrowOnError extends boolean = false>(options: Options<CreateOrganizationApiV1SuperuserOrganizationsPostData, ThrowOnError>) => (options.client ?? client).post<CreateOrganizationApiV1SuperuserOrganizationsPostResponses, CreateOrganizationApiV1SuperuserOrganizationsPostErrors, ThrowOnError>({
 ...
 * Delete Organization
 */
export const deleteOrganizationApiV1SuperuserOrganizationsOrgIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteOrganizationApiV1SuperuserOrganizationsOrgIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteOrganizationApiV1SuperuserOrganizationsOrgIdDeleteResponses, DeleteOrganizationApiV1SuperuserOrganizationsOrgIdDeleteErrors, ThrowOnError>({ url: '/api/v1/superuser/organizations/{org_id}', ...options });

/**
 * Update Organization
 */
export const updateOrganizationApiV1SuperuserOrganizationsOrgIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateOrganizationApiV1SuperuserOrganizationsOrgIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateOrganizationApiV1SuperuserOrganizationsOrgIdPatchResponses, UpdateOrganizationApiV1SuperuserOrganizationsOrgIdPatchErrors, ThrowOnError>({
    url: '/api/v1/superuser/organizations/{org_id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Assign User
 */
export const assignUserApiV1SuperuserOrganizationsOrgIdAssignUserPost = <ThrowOnError extends boolean = false>(options: Options<AssignUserApiV1SuperuserOrganizationsOrgIdAssignUserPostData, ThrowOnError>) => (options.client ?? client).post<AssignUserApiV1SuperuserOrganizationsOrgIdAssignUserPostResponses, AssignUserApiV1SuperuserOrganizationsOrgIdAssignUserPostErrors, ThrowOnError>({
    url: '/api/v1/superuser/organizations/{org_id}/assign-user',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Remove User
 */
export const removeUserApiV1SuperuserOrganizationsOrgIdRemoveUserPost = <ThrowOnError extends boolean = false>(options: Options<RemoveUserApiV1SuperuserOrganizationsOrgIdRemoveUserPostData, ThrowOnError>) => (options.client ?? client).post<RemoveUserApiV1SuperuserOrganizationsOrgIdRemoveUserPostResponses, RemoveUserApiV1SuperuserOrganizationsOrgIdRemoveUserPostErrors, ThrowOnError>({
    url: '/api/v1/superuser/organizations/{org_id}/remove-user',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Get Org Members
 */
export const getOrgMembersApiV1SuperuserOrganizationsOrgIdMembersGet = <ThrowOnError extends boolean = false>(options: Options<GetOrgMembersApiV1SuperuserOrganizationsOrgIdMembersGetData, ThrowOnError>) => (options.client ?? client).get<GetOrgMembersApiV1SuperuserOrganizationsOrgIdMembersGetResponses, GetOrgMembersApiV1SuperuserOrganizationsOrgIdMembersGetErrors, ThrowOnError>({ url: '/api/v1/superuser/organizations/{org_id}/members', ...options });

/**
 * Switch Org
 */
export const switchOrgApiV1SuperuserSwitchOrgPost = <ThrowOnError extends boolean = false>(options: Options<SwitchOrgApiV1SuperuserSwitchOrgPostData, ThrowOnError>) => (options.client ?? client).post<SwitchOrgApiV1SuperuserSwitchOrgPostResponses, SwitchOrgApiV1SuperuserSwitchOrgPostErrors, ThrowOnError>({
 ...
 */
export const listAllUsersApiV1SuperuserUsersGet = <ThrowOnError extends boolean = false>(options?: Options<ListAllUsersApiV1SuperuserUsersGetData, ThrowOnError>) => (options?.client ?? client).get<ListAllUsersApiV1SuperuserUsersGetResponses, ListAllUsersApiV1SuperuserUsersGetErrors, ThrowOnError>({ url: '/api/v1/superuser/users', ...options });
 ...
 */
export const updateUserRoleApiV1SuperuserUsersUserIdRolePatch = <ThrowOnError extends boolean = false>(options: Options<UpdateUserRoleApiV1SuperuserUsersUserIdRolePatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateUserRoleApiV1SuperuserUsersUserIdRolePatchResponses, UpdateUserRoleApiV1SuperuserUsersUserIdRolePatchErrors, ThrowOnError>({
    url: '/api/v1/superuser/users/{user_id}/role',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * List Organization Runs For Audit
 *
 * List all workflow runs for a specific organization in a billing cycle for superadmin audit.
 */
export const listOrganizationRunsForAuditApiV1SuperuserOrganizationsOrgIdRunsGet = <ThrowOnError extends boolean = false>(options: Options<ListOrganizationRunsForAuditApiV1SuperuserOrganizationsOrgIdRunsGetData, ThrowOnError>) => (options.client ?? client).get<ListOrganizationRunsForAuditApiV1SuperuserOrganizationsOrgIdRunsGetResponses, ListOrganizationRunsForAuditApiV1SuperuserOrganizationsOrgIdRunsGetErrors, ThrowOnError>({ url: '/api/v1/superuser/organizations/{org_id}/runs', ...options });

/**
 * Delete Workflow Run For Audit
 *
 * Delete a workflow run and recalculate the corresponding usage cycle duration.
 */
export const deleteWorkflowRunForAuditApiV1SuperuserRunsRunIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteWorkflowRunForAuditApiV1SuperuserRunsRunIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteWorkflowRunForAuditApiV1SuperuserRunsRunIdDeleteResponses, DeleteWorkflowRunForAuditApiV1SuperuserRunsRunIdDeleteErrors, ThrowOnError>({ url: '/api/v1/superuser/runs/{run_id}', ...options });
 ...
 */
export const deleteAllWorkflowRunsApiV1SuperuserRunsDelete = <ThrowOnError extends boolean = false>(options?: Options<DeleteAllWorkflowRunsApiV1SuperuserRunsDeleteData, ThrowOnError>) => (options?.client ?? client).delete<DeleteAllWorkflowRunsApiV1SuperuserRunsDeleteResponses, DeleteAllWorkflowRunsApiV1SuperuserRunsDeleteErrors, ThrowOnError>({ url: '/api/v1/superuser/runs', ...options });
 ...
 */
export const deleteCampaignApiV1CampaignCampaignIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteCampaignApiV1CampaignCampaignIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteCampaignApiV1CampaignCampaignIdDeleteResponses, DeleteCampaignApiV1CampaignCampaignIdDeleteErrors, ThrowOnError>({ url: '/api/v1/campaign/{campaign_id}', ...options });
 ...
 */
export const validateSourceConfigApiV1CampaignValidateSourcePost = <ThrowOnError extends boolean = false>(options: Options<ValidateSourceConfigApiV1CampaignValidateSourcePostData, ThrowOnError>) => (options.client ?? client).post<ValidateSourceConfigApiV1CampaignValidateSourcePostResponses, ValidateSourceConfigApiV1CampaignValidateSourcePostErrors, ThrowOnError>({
...
/**
 * List Crm Credentials
 *
 * List all CRM credentials for organization.
 */
export const listCrmCredentialsApiV1CrmCredentialsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCrmCredentialsApiV1CrmCredentialsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCrmCredentialsApiV1CrmCredentialsGetResponses, ListCrmCredentialsApiV1CrmCredentialsGetErrors, ThrowOnError>({ url: '/api/v1/crm-credentials', ...options });
 ...
 */
export const saveCrmCredentialApiV1CrmCredentialsPost = <ThrowOnError extends boolean = false>(options: Options<SaveCrmCredentialApiV1CrmCredentialsPostData, ThrowOnError>) => (options.client ?? client).post<SaveCrmCredentialApiV1CrmCredentialsPostResponses, SaveCrmCredentialApiV1CrmCredentialsPostErrors, ThrowOnError>({
...
/**
 * Delete Crm Credential
 *
 * Delete CRM credential for provider.
 */
export const deleteCrmCredentialApiV1CrmCredentialsProviderDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteCrmCredentialApiV1CrmCredentialsProviderDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteCrmCredentialApiV1CrmCredentialsProviderDeleteResponses, DeleteCrmCredentialApiV1CrmCredentialsProviderDeleteErrors, ThrowOnError>({ url: '/api/v1/crm-credentials/{provider}', ...options });
 ...
 */
export const getCrmCredentialApiV1CrmCredentialsProviderGet = <ThrowOnError extends boolean = false>(options: Options<GetCrmCredentialApiV1CrmCredentialsProviderGetData, ThrowOnError>) => (options.client ?? client).get<GetCrmCredentialApiV1CrmCredentialsProviderGetResponses, GetCrmCredentialApiV1CrmCredentialsProviderGetErrors, ThrowOnError>({ url: '/api/v1/crm-credentials/{provider}', ...options });
 ...
 */
export const getBillingConfigurationApiV1OrganizationsBillingConfigGet = <ThrowOnError extends boolean = false>(options?: Options<GetBillingConfigurationApiV1OrganizationsBillingConfigGetData, ThrowOnError>) => (options?.client ?? client).get<GetBillingConfigurationApiV1OrganizationsBillingConfigGetResponses, GetBillingConfigurationApiV1OrganizationsBillingConfigGetErrors, ThrowOnError>({ url: '/api/v1/organizations/billing-config', ...options });
 ...
 */
export const saveBillingConfigurationApiV1OrganizationsBillingConfigPost = <ThrowOnError extends boolean = false>(options: Options<SaveBillingConfigurationApiV1OrganizationsBillingConfigPostData, ThrowOnError>) => (options.client ?? client).post<SaveBillingConfigurationApiV1OrganizationsBillingConfigPostResponses, SaveBillingConfigurationApiV1OrganizationsBillingConfigPostErrors, ThrowOnError>({
 ...
 */
export const updateMemberRoleApiV1OrganizationsMembersMemberIdRolePatch = <ThrowOnError extends boolean = false>(options: Options<UpdateMemberRoleApiV1OrganizationsMembersMemberIdRolePatchData, ThrowOnError>) => (options.client ?? client).patch<UpdateMemberRoleApiV1OrganizationsMembersMemberIdRolePatchResponses, UpdateMemberRoleApiV1OrganizationsMembersMemberIdRolePatchErrors, ThrowOnError>({
    url: '/api/v1/organizations/members/{member_id}/role',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const removeMemberApiV1OrganizationsMembersMemberIdDelete = <ThrowOnError extends boolean = false>(options: Options<RemoveMemberApiV1OrganizationsMembersMemberIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<RemoveMemberApiV1OrganizationsMembersMemberIdDeleteResponses, RemoveMemberApiV1OrganizationsMembersMemberIdDeleteErrors, ThrowOnError>({ url: '/api/v1/organizations/members/{member_id}', ...options });
 ...
 */
export const createInviteApiV1OrganizationsInvitesPost = <ThrowOnError extends boolean = false>(options: Options<CreateInviteApiV1OrganizationsInvitesPostData, ThrowOnError>) => (options.client ?? client).post<CreateInviteApiV1OrganizationsInvitesPostResponses, CreateInviteApiV1OrganizationsInvitesPostErrors, ThrowOnError>({
 ...
 */
export const getWalletApiV1OrganizationsWalletGet = <ThrowOnError extends boolean = false>(options?: Options<GetWalletApiV1OrganizationsWalletGetData, ThrowOnError>) => (options?.client ?? client).get<GetWalletApiV1OrganizationsWalletGetResponses, GetWalletApiV1OrganizationsWalletGetErrors, ThrowOnError>({ url: '/api/v1/organizations/wallet', ...options });
 ...
 */
export const acceptInviteApiV1AuthAcceptInvitePost = <ThrowOnError extends boolean = false>(options: Options<AcceptInviteApiV1AuthAcceptInvitePostData, ThrowOnError>) => (options.client ?? client).post<AcceptInviteApiV1AuthAcceptInvitePostResponses, AcceptInviteApiV1AuthAcceptInvitePostErrors, ThrowOnError>({
 ...
 */
export const verifyWebhookApiV1WhatsappWebhookOrgIdGet = <ThrowOnError extends boolean = false>(options: Options<VerifyWebhookApiV1WhatsappWebhookOrgIdGetData, ThrowOnError>) => (options.client ?? client).get<VerifyWebhookApiV1WhatsappWebhookOrgIdGetResponses, VerifyWebhookApiV1WhatsappWebhookOrgIdGetErrors, ThrowOnError>({ url: '/api/v1/whatsapp/webhook/{org_id}', ...options });
 ...
 */
export const handleWebhookCallbackApiV1WhatsappWebhookOrgIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleWebhookCallbackApiV1WhatsappWebhookOrgIdPostData, ThrowOnError>) => (options.client ?? client).post<HandleWebhookCallbackApiV1WhatsappWebhookOrgIdPostResponses, HandleWebhookCallbackApiV1WhatsappWebhookOrgIdPostErrors, ThrowOnError>({ url: '/api/v1/whatsapp/webhook/{org_id}', ...options });
 ...
 */
export const listWhatsappLogsApiV1WhatsappLogsGet = <ThrowOnError extends boolean = false>(options?: Options<ListWhatsappLogsApiV1WhatsappLogsGetData, ThrowOnError>) => (options?.client ?? client).get<ListWhatsappLogsApiV1WhatsappLogsGetResponses, ListWhatsappLogsApiV1WhatsappLogsGetErrors, ThrowOnError>({ url: '/api/v1/whatsapp/logs', ...options });
 ...
 */
export const retryWhatsappMessageApiV1WhatsappLogsMessageIdRetryPost = <ThrowOnError extends boolean = false>(options: Options<RetryWhatsappMessageApiV1WhatsappLogsMessageIdRetryPostData, ThrowOnError>) => (options.client ?? client).post<RetryWhatsappMessageApiV1WhatsappLogsMessageIdRetryPostResponses, RetryWhatsappMessageApiV1WhatsappLogsMessageIdRetryPostErrors, ThrowOnError>({ url: '/api/v1/whatsapp/logs/{message_id}/retry', ...options });
